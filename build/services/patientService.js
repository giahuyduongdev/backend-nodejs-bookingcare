...
var postBookAppointment = function postBookAppointment(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var token, user, check, check1;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            if (!(!data.email || !data.doctorId || !data.timeType || !data.date || !data.fullName || !data.selectedGender || !data.address || !data.phonenumber || !data.birthday || !data.reason)) {
              _context2.next = 5;
              break;
            }
            resolve({
...
var getListAppointmentForPatient = function getListAppointmentForPatient(patientId, date) {
  return new Promise(/*#__PURE__*/function () {
