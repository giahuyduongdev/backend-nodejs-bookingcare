...
var handleRegisterNewUser = /*#__PURE__*/function () {
  ...
  return function handleRegisterNewUser(_x7, _x8) {
...
var handleChangePassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          data = req.body;
          _context7.next = 3;
          return _userService["default"].changeAccountPassword(data);
        case 3:
  ...
  return function handleChangePassword(_x13, _x14) {
...
var postForgotPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
          _context9.next = 3;
          return _userService["default"].postForgotPasswordService(req.body);
        case 3:
  ...
  return function postForgotPassword(_x17, _x18) {
    return _ref9.apply(this, arguments);
  };
}();
var postVerifyRetrievePassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.prev = 0;
          _context10.next = 3;
          return _userService["default"].postVerifyRetrievePasswordService(req.body);
        case 3:
  ...
  return function postVerifyRetrievePassword(_x19, _x20) {
    return _ref10.apply(this, arguments);
  };
}();
var postConFirmNewAccount = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          _context11.prev = 0;
          _context11.next = 3;
          return _userService["default"].postCofirmAccountService(req.body);
        case 3:
  ...
  return function postConFirmNewAccount(_x21, _x22) {
...
var postConfirmNewAccountEmail = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          _context12.prev = 0;
          _context12.next = 3;
          return _userService["default"].postConFirmNewAccountEmail(req.body);
        case 3:
  ...
  return function postConfirmNewAccountEmail(_x23, _x24) {
    return _ref12.apply(this, arguments);
  };
}();
var getUserInfoProfile = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 3:
          _context13.next = 5;
          return _userService["default"].getUserInfoProfile(email);
        case 5:
  ...
  return function getUserInfoProfile(_x25, _x26) {
