...
var displayUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          data = _context2.sent;
          return _context2.abrupt("return", res.render("displayUser.ejs", {
            data: data
          }));
        case 4:
        case "end":
  ...
  return function displayUser(_x3, _x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          console.log(message);
          return _context3.abrupt("return", res.send("Thêm người dùng mới thành công"));
        case 6:
        case "end":
...
var postEditUser = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          userData = req.body;
          _context5.next = 3;
          return _CRUDService["default"].updateUserData(userData);
        case 3:
          allUsers = _context5.sent;
          return _context5.abrupt("return", res.render("displayUser", {
            data: allUsers
          }));
        case 5:
        case "end":
  ...
  return function postEditUser(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var deleteUser = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var id, data, allUsers;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 7:
          ...
          return _context6.abrupt("return", res.send('Deleted'));
        case 11:
